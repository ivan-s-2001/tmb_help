      ...
      sections: [
        {
          id: 'demo-basic',
          title: 'Базовые блоки',
          description: 'Спокойные базовые элементы, которые должны быстро читаться без лишнего визуального шума.',
          blocks: [
            {
              id: 'demo-text',
              type: 'text',
        ...
        {
          id: 'demo-accent-cards',
          title: 'Акценты и карточки',
          description: 'Блоки, которые должны быть заметнее обычного текста, но не превращать экран в пёстрый набор плашек.',
          blocks: [
            {
              id: 'demo-accent-tip',
              type: 'accent',
              ...
              text: 'Подходит для мысли, которую важно заметить быстро. Он должен отличаться от текста и списка по характеру и приоритету.',
            },
            {
              ...
              text: 'Такой вариант нужен там, где ошибка по ходу партии особенно болезненна и это стоит визуально подчеркнуть.',
            },
            {
              id: 'demo-cards',
              type: 'cards',
              items: [
                {
                  title: 'Карточка 1',
                  text: 'Отдельная смысловая плитка для короткой законченной мысли.',
                },
                {
                  title: 'Карточка 2',
                  text: 'Карточки полезны, когда нужно сравнивать несколько параллельных идей.',
                },
              ],
            },
          ],
        ...
        {
          id: 'demo-process',
          title: 'Маршрут, чеклист и трекер',
          description: 'Процессные блоки, которые должны отличаться от контентных и помогать действовать, а не только читать.',
          blocks: [
            {
              id: 'demo-route',
              type: 'route',
              ...
              steps: [
                ...
                {
                  label: 'Вернись к решению',
                  note: 'Помощник должен ускорять, а не замедлять ход.',
                },
              ],
            },
            {
            ...
            },
            {
              ...
              type: 'tracker',
              title: 'Трекер',
              note: 'Компактный визуальный счётчик для локального состояния.',
              min: 0,
              max: 4,
              step: 1,
              initialValue: 2,
